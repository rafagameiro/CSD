...
@ComponentScan(basePackages = "app", excludeFilters = {
        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {MainApplication.class, CommandLineApp.class})})
public class BenchmarkClient implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        BenchmarkService benchmarkService = new BenchmarkService(restTemplate, defaultUri);
    ...
    //Override default errorhandler to avoid unwanted errors
