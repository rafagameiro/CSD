...
import app.benchmarks.BenchmarkClient;
...
@ComponentScan(basePackages = "app", excludeFilters = {
        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {BenchmarkClient.class, BenchmarkService.class})})
public class MainApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        CommandLineApp app = new CommandLineApp(restTemplate, defaultUri, replyManager);
        app.run();
    }
    ...
    //Override default error handler to avoid unwanted errors
